...
import com.hrmpandjiadhi.databinding.ActivityTimeSheetBinding
...
class TimeSheetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (layout == "staff") {
            binding.toolbar.title = "TimeSheet-Staff"
            url = "https://i.mahawangsa.com/vformstaff"
        }else{
            binding.toolbar.title = "TimeSheet-Personil"
            url = "https://i.mahawangsa.com/vformpers"
        }
