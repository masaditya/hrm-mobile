...
import com.hrmpandjiadhi.databinding.ActivityChangePasswordStaffBinding
import com.hrmpandjiadhi.ui.viewmodel.auth.AuthViewModel
import com.hrmpandjiadhi.ui.viewmodel.auth.AuthViewModelFactory

class ChangePasswordStaffActivity : AppCompatActivity() {

    private lateinit var binding: ActivityChangePasswordStaffBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityChangePasswordStaffBinding.inflate(layoutInflater)
